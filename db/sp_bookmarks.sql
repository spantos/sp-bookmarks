...
--
-- Host: 127.0.0.1    Database: sp_bookmarks
-- ------------------------------------------------------
...
CREATE TABLE `login_attempts` (
  `id_login_attempt` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `users` (
  ...
  `forgot_password_code` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id_user`)
...
-- Dump completed on 2016-10-12 21:26:36
